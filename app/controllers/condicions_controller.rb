class CondicionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @condicion.save
        format.html { redirect_to @condicion, notice: 'Condicion was successfully created.' }
  ...
  private
    ...
    def condicion_params
      params.require(:condicion).permit(:condicion_id, :tipo_trans_id, :condicion_porcentaje_comision)
    end
end
