class AuditoriaController < ApplicationController
  ...
  private
    ...
    def auditorium_params
      params.require(:auditorium).permit(:auditoria_id, :auditoria_usuario, :auditoria_tabla_mod, :auditoria_operacion, :auditoria_fecha, :auditoria_attr_mod, :auditoria_antes, :auditoria_despues)
    end
end
